...
public class DataUtility {
	...
	public static long getRandom() {
		...
		return rand.nextLong(1000, 99999);
	}
	
	public static long getRandomCibil() {
		Random rand = new Random();
		return rand.nextLong(700, 900);
	}
	
	public static long getRandomLoanAccNumber() {
		Random rand = new Random();
		return rand.nextLong(10000, 9999999);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(DataUtility.getDate1("2023-06-01"));;
	}
