...
<div class="home-content-wrapper">
  <div class="overlay-box">
   <div class="container">
    ...
    <sf:form method="post" action="${pageContext.request.contextPath}/GetOtp" modelAttribute="form">
            <sf:input type="hidden" id="id" class="form-control form-control-lg" path="id" name="id" value="${form.id}"/>
              <div class="row">
                <div class="col-md-6 mb-4">
                  <div class="form-outline">   
                  <s:bind path="email">
                  <label class="form-label" for="email" style="color: white;">Enter Your Email for OTP</label>
                  <sf:input type="text" id="email" class="form-control form-control-lg" path="email" name="email"/>
...
<h6 class="text-center">Manage Education and Personal Loan</h6>
</div>
